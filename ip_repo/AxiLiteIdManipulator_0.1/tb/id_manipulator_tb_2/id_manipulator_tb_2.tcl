...
################################################################
# This is a generated script based on design: id_manipulator_tb_2
#
...
# source id_manipulator_tb_2_script.tcl
...
set design_name id_manipulator_tb_2
...
proc create_root_design { parentCell } {
  ...
  # Create instance: AxiLiteIdManipulator_1, and set properties
  set AxiLiteIdManipulator_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:AxiLiteIdManipulator:0.1 AxiLiteIdManipulator_1 ]
  ...
  connect_bd_intf_net -intf_net AxiLiteIdManipulator_0_M_AXI [get_bd_intf_pins AxiLiteIdManipulator_0/M_AXI] [get_bd_intf_pins smartconnect_0/S00_AXI]
  connect_bd_intf_net -intf_net AxiLiteIdManipulator_1_M_AXI [get_bd_intf_pins AxiLiteIdManipulator_1/M_AXI] [get_bd_intf_pins smartconnect_0/S01_AXI]
  ...
  connect_bd_intf_net -intf_net axi_traffic_gen_1_M_AXI_LITE_CH1 [get_bd_intf_pins AxiLiteIdManipulator_1/S_AXI] [get_bd_intf_pins axi_traffic_gen_1/M_AXI_LITE_CH1]
  ...
  assign_bd_address -offset 0x00000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces AxiLiteIdManipulator_0/M_AXI] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0x00000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces AxiLiteIdManipulator_1/M_AXI] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] -force
  ...
  assign_bd_address -offset 0x00000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces axi_traffic_gen_1/Reg1] [get_bd_addr_segs AxiLiteIdManipulator_1/S_AXI/S_AXI_reg] -force
