...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_S_AXI_CONFIG_ID_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_S_AXI_CONFIG_DATA_WIDTH" -parent ${Page_0} -widget comboBox
  ipgui::add_param $IPINST -name "C_S_AXI_CONFIG_ADDR_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_S_AXI_CONFIG_AWUSER_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_S_AXI_CONFIG_ARUSER_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_S_AXI_CONFIG_WUSER_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_S_AXI_CONFIG_RUSER_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_S_AXI_CONFIG_BUSER_WIDTH" -parent ${Page_0}
...
proc update_PARAM_VALUE.C_S_AXI_CONFIG_ID_WIDTH { PARAM_VALUE.C_S_AXI_CONFIG_ID_WIDTH } {
	# Procedure called to update C_S_AXI_CONFIG_ID_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_S_AXI_CONFIG_ID_WIDTH { PARAM_VALUE.C_S_AXI_CONFIG_ID_WIDTH } {
	# Procedure called to validate C_S_AXI_CONFIG_ID_WIDTH
	return true
}
...
proc update_PARAM_VALUE.C_S_AXI_CONFIG_AWUSER_WIDTH { PARAM_VALUE.C_S_AXI_CONFIG_AWUSER_WIDTH } {
	# Procedure called to update C_S_AXI_CONFIG_AWUSER_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_S_AXI_CONFIG_AWUSER_WIDTH { PARAM_VALUE.C_S_AXI_CONFIG_AWUSER_WIDTH } {
	# Procedure called to validate C_S_AXI_CONFIG_AWUSER_WIDTH
	return true
}

proc update_PARAM_VALUE.C_S_AXI_CONFIG_ARUSER_WIDTH { PARAM_VALUE.C_S_AXI_CONFIG_ARUSER_WIDTH } {
	# Procedure called to update C_S_AXI_CONFIG_ARUSER_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_S_AXI_CONFIG_ARUSER_WIDTH { PARAM_VALUE.C_S_AXI_CONFIG_ARUSER_WIDTH } {
	# Procedure called to validate C_S_AXI_CONFIG_ARUSER_WIDTH
	return true
}

proc update_PARAM_VALUE.C_S_AXI_CONFIG_WUSER_WIDTH { PARAM_VALUE.C_S_AXI_CONFIG_WUSER_WIDTH } {
	# Procedure called to update C_S_AXI_CONFIG_WUSER_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_S_AXI_CONFIG_WUSER_WIDTH { PARAM_VALUE.C_S_AXI_CONFIG_WUSER_WIDTH } {
	# Procedure called to validate C_S_AXI_CONFIG_WUSER_WIDTH
	return true
}

proc update_PARAM_VALUE.C_S_AXI_CONFIG_RUSER_WIDTH { PARAM_VALUE.C_S_AXI_CONFIG_RUSER_WIDTH } {
	# Procedure called to update C_S_AXI_CONFIG_RUSER_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_S_AXI_CONFIG_RUSER_WIDTH { PARAM_VALUE.C_S_AXI_CONFIG_RUSER_WIDTH } {
	# Procedure called to validate C_S_AXI_CONFIG_RUSER_WIDTH
	return true
}

proc update_PARAM_VALUE.C_S_AXI_CONFIG_BUSER_WIDTH { PARAM_VALUE.C_S_AXI_CONFIG_BUSER_WIDTH } {
	# Procedure called to update C_S_AXI_CONFIG_BUSER_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_S_AXI_CONFIG_BUSER_WIDTH { PARAM_VALUE.C_S_AXI_CONFIG_BUSER_WIDTH } {
	# Procedure called to validate C_S_AXI_CONFIG_BUSER_WIDTH
	return true
}
...
proc update_MODELPARAM_VALUE.C_S_AXI_CONFIG_ID_WIDTH { MODELPARAM_VALUE.C_S_AXI_CONFIG_ID_WIDTH PARAM_VALUE.C_S_AXI_CONFIG_ID_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_S_AXI_CONFIG_ID_WIDTH}] ${MODELPARAM_VALUE.C_S_AXI_CONFIG_ID_WIDTH}
}
...
proc update_MODELPARAM_VALUE.C_S_AXI_CONFIG_AWUSER_WIDTH { MODELPARAM_VALUE.C_S_AXI_CONFIG_AWUSER_WIDTH PARAM_VALUE.C_S_AXI_CONFIG_AWUSER_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_S_AXI_CONFIG_AWUSER_WIDTH}] ${MODELPARAM_VALUE.C_S_AXI_CONFIG_AWUSER_WIDTH}
}

proc update_MODELPARAM_VALUE.C_S_AXI_CONFIG_ARUSER_WIDTH { MODELPARAM_VALUE.C_S_AXI_CONFIG_ARUSER_WIDTH PARAM_VALUE.C_S_AXI_CONFIG_ARUSER_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_S_AXI_CONFIG_ARUSER_WIDTH}] ${MODELPARAM_VALUE.C_S_AXI_CONFIG_ARUSER_WIDTH}
}

proc update_MODELPARAM_VALUE.C_S_AXI_CONFIG_WUSER_WIDTH { MODELPARAM_VALUE.C_S_AXI_CONFIG_WUSER_WIDTH PARAM_VALUE.C_S_AXI_CONFIG_WUSER_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_S_AXI_CONFIG_WUSER_WIDTH}] ${MODELPARAM_VALUE.C_S_AXI_CONFIG_WUSER_WIDTH}
}

proc update_MODELPARAM_VALUE.C_S_AXI_CONFIG_RUSER_WIDTH { MODELPARAM_VALUE.C_S_AXI_CONFIG_RUSER_WIDTH PARAM_VALUE.C_S_AXI_CONFIG_RUSER_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_S_AXI_CONFIG_RUSER_WIDTH}] ${MODELPARAM_VALUE.C_S_AXI_CONFIG_RUSER_WIDTH}
}

proc update_MODELPARAM_VALUE.C_S_AXI_CONFIG_BUSER_WIDTH { MODELPARAM_VALUE.C_S_AXI_CONFIG_BUSER_WIDTH PARAM_VALUE.C_S_AXI_CONFIG_BUSER_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_S_AXI_CONFIG_BUSER_WIDTH}] ${MODELPARAM_VALUE.C_S_AXI_CONFIG_BUSER_WIDTH}
}
