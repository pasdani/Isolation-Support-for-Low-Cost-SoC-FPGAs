...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.MEM_REGION_1 {0x00000000} \
   CONFIG.MEM_REGION_10_LSB {0} \
   CONFIG.MEM_REGION_11_LSB {0} \
   CONFIG.MEM_REGION_12_LSB {0} \
   CONFIG.MEM_REGION_13_LSB {0} \
   CONFIG.MEM_REGION_14_LSB {0} \
   CONFIG.MEM_REGION_15_LSB {0} \
   CONFIG.MEM_REGION_1_LSB {0} \
   CONFIG.MEM_REGION_2_LSB {0} \
   CONFIG.MEM_REGION_3_LSB {0} \
   CONFIG.MEM_REGION_4_LSB {0} \
   CONFIG.MEM_REGION_5_LSB {0} \
   CONFIG.MEM_REGION_6_LSB {0} \
   CONFIG.MEM_REGION_7_LSB {0} \
   CONFIG.MEM_REGION_8_LSB {0} \
   CONFIG.MEM_REGION_9_LSB {0} \
