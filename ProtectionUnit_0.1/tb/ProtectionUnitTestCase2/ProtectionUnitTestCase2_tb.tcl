...
################################################################
# This is a generated script based on design: ProtectionUnitTestCase2_tb
#
...
# source ProtectionUnitTestCase2_tb_script.tcl
...
set design_name ProtectionUnitTestCase2_tb
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.MEM_REGION_1_LSB {8} \
   CONFIG.MEM_REGION_2 {0x00010000} \
   CONFIG.MEM_REGION_2_LSB {8} \
   CONFIG.NUM_DOMAINS {1} \
   CONFIG.NUM_MEM_REGIONS {3} \
 ] $ProtectionUnit_0
  ...
  connect_bd_intf_net -intf_net ProtectionUnit_0_M_AXI_PT [get_bd_intf_pins ProtectionUnit_0/M_AXI_PT] [get_bd_intf_pins axi_interconnect_0/S00_AXI]
  connect_bd_intf_net -intf_net ProtectionUnit_1_M_AXI_PT [get_bd_intf_pins ProtectionUnit_1/M_AXI_PT] [get_bd_intf_pins axi_interconnect_0/S01_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins axi_vip_slave_0/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins axi_interconnect_0/M01_AXI] [get_bd_intf_pins axi_vip_slave1/S_AXI]
  ...
  connect_bd_intf_net -intf_net axi_vip_master1_M_AXI [get_bd_intf_pins ProtectionUnit_1/S_AXI_PT] [get_bd_intf_pins axi_vip_master1/M_AXI]
  connect_bd_intf_net -intf_net axi_vip_master_0_M_AXI [get_bd_intf_pins ProtectionUnit_0/S_AXI_PT] [get_bd_intf_pins axi_vip_master_0/M_AXI]

  # Create port connections
  connect_bd_net -net ARESETN_1 [get_bd_pins ProtectionUnit_0/aresetn] [get_bd_pins ProtectionUnit_1/aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/M01_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_vip_config/aresetn] [get_bd_pins axi_vip_master1/aresetn] [get_bd_pins axi_vip_master_0/aresetn] [get_bd_pins axi_vip_slave1/aresetn] [get_bd_pins axi_vip_slave_0/aresetn] [get_bd_pins sim_clk_gen_0/sync_rst]
  connect_bd_net -net Net [get_bd_pins ProtectionUnit_0/aclk] [get_bd_pins ProtectionUnit_1/aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/M01_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_vip_config/aclk] [get_bd_pins axi_vip_master1/aclk] [get_bd_pins axi_vip_master_0/aclk] [get_bd_pins axi_vip_slave1/aclk] [get_bd_pins axi_vip_slave_0/aclk] [get_bd_pins sim_clk_gen_0/clk]

  # Create address segments
  assign_bd_address -offset 0x00000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ProtectionUnit_0/M_AXI_PT] [get_bd_addr_segs axi_vip_slave1/S_AXI/Reg] -force
  assign_bd_address -offset 0x00010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ProtectionUnit_0/M_AXI_PT] [get_bd_addr_segs axi_vip_slave_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x00000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ProtectionUnit_1/M_AXI_PT] [get_bd_addr_segs axi_vip_slave1/S_AXI/Reg] -force
  assign_bd_address -offset 0x00010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ProtectionUnit_1/M_AXI_PT] [get_bd_addr_segs axi_vip_slave_0/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x00000000 -range 0x00020000 -target_address_space [get_bd_addr_spaces axi_vip_master1/Master_AXI] [get_bd_addr_segs ProtectionUnit_1/S_AXI_PT/reg0] -force
  assign_bd_address -offset 0x00000000 -range 0x00020000 -target_address_space [get_bd_addr_spaces axi_vip_master_0/Master_AXI] [get_bd_addr_segs ProtectionUnit_0/S_AXI_PT/reg0] -force
